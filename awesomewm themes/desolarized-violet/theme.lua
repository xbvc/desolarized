...
-- {{{ Main
theme = {}
theme.confdir       = awful.util.getdir("config") .. "/themes/desolarized-violet/"
...
-- {{{ Colors
theme.fg_normal = "#919191" -- light grey (body text/primary)
theme.fg_focus  = "#4951a3" -- violet
theme.fg_urgent = "#a34951" -- red
theme.bg_normal = "#262626" -- dark grey
theme.bg_focus  = "#1b1b1b" -- very dark grey
theme.bg_urgent = theme.bg_normal
-- }}}

-- {{{ Borders
theme.border_width  = 1
theme.border_focus  = "#4951a3" -- violet
...
-- {{{ Widgets
theme.fg_widget        = "#AECF96" -- light green
theme.fg_center_widget = "#88A175" -- green
theme.fg_end_widget    = "#FF5656" -- red
theme.fg_off_widget    = "#494B4F" -- grey
theme.fg_netup_widget  = "#7F9F7F" -- green
